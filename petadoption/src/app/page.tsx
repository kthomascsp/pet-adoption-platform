        ...
        <div className="font-bold">
            <div className="flex flex-col items-center justify-evenly">
                ...
                <p className="text-2xl p-8 w-[40%]">
                    We are a pet adoption organization dedicated to providing consumers with only the very best in
                    customer service
            ...
            <div className="flex justify-evenly items-center p-20">
                ...
                <p className="text-2xl p-8 w-[30%] rounded-lg">
                    We have a wide variety of dog and cat breeds. We also have other types of pets like reptiles and
                    mammals.
                </p>
            </div>
            <div className="flex justify-evenly items-center p-20">
                <p className="text-2xl p-8 w-[30%] rounded-lg">
                    View an extensive network of shelters in your local area. Message them to continue the adoption
                    process.
                </p>
